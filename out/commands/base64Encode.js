...
function registerCommand(context) {
    const disposable = vscode.commands.registerCommand('dev-pocket.base64Encode', async () => {
        ...
        try {
            const encoded = (0, base64Codec_1.encode)(content);
            ...
            vscode.window.showErrorMessage(`Encoding failed: ${message}`);
        }
    });
